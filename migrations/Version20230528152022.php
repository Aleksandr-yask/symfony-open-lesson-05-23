 ...
 */
final class Version20230528152022 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "order" (id INT NOT NULL, customer_id INT DEFAULT NULL, restaurant_id INT DEFAULT NULL, PRIMARY KEY(id))');
